...
/* package sigma-lang-0.1.0.0 */
#define VERSION_sigma_lang "0.1.0.0"
#define MIN_VERSION_sigma_lang(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* tool cpphs-1.20.7 */
#define TOOL_VERSION_cpphs "1.20.7"
...
#define CURRENT_COMPONENT_ID "sigma-lang-0.1.0.0"

#define CURRENT_PACKAGE_KEY "sigma-lang-0.1.0.0"
